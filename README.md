...
Dataset: Synthetic dataset simulating realistic Uber ride-sharing operations for 2024 (~150,000 records)[cite: 2].

Core Objective: Leverage Python, SQL, and Power BI to analyze supply-demand gaps, cancellation root causes, revenue drivers, and customer loyalty segments to formulate actionable strategic recommendations[cite: 2].
